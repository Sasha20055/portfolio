        ...
        <div className="row about__row">
          <div className="col-md-6 ">
            ...
            <p>Фронтенд разработчик. Активно занимаюсь веб-разработкой уже 2 года.
              ...
              Есть огромное стремление и упорство развиваться в It индустрии. Также есть Пэт-проекты, которые вы можете просмотреть в разделе <a href="/#projects">ПРОЕКТЫ</a>. Имею опыт совместной разработки проектов и
